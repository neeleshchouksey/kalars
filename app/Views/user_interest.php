...
<aside class="sidebar column fourcol last">
	...
	<div class="widget profile-menu">
		<ul>
			<li class="current" style="cursor:pointer" onclick="accept_interest_list();"><b>Accept_Interest</b></li>
			<li class="current" style="cursor:pointer" onclick="archive_interest_list();"><b>Archive_Interest</b></li>
		</ul>
	</div>
